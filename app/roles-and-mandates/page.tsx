    ...
    <>
      ...
      <main className="bg-[#F7F6F3] text-[#111111] min-h-screen font-sans px-6 md:px-12 pt-32 pb-24">
        ...
        <section className="max-w-5xl mx-auto text-center mb-24">
          <p className="text-[10px] uppercase tracking-[0.3em] opacity-50 mb-6">Roles &amp; Mandates</p>
          <h1 className="text-4xl md:text-5xl font-black mb-6 leading-tight text-balance">Search coverage across the renewable energy lifecycle.</h1>
          <p className="text-lg opacity-75 max-w-3xl mx-auto">Meridian Stone Search partners with developers, EPCs, investors, and growth platforms to hire proven operators across solar, storage, and infrastructure.</p>
          <p className="text-sm opacity-60 max-w-3xl mx-auto mt-4">From early-stage development through engineering, EPC execution, construction leadership, and executive buildouts, we support targeted search mandates across the roles that drive project delivery and platform growth.</p>
        </section>
        ...
        <section className="max-w-4xl mx-auto mb-24 text-center">
          <h2 className="text-2xl md:text-3xl font-black mb-6">Typical mandates include</h2>
          <div className="grid md:grid-cols-2 gap-4 text-sm opacity-70"><div>Confidential replacements</div><div>Team buildouts</div><div>First-in-market hires</div><div>Leadership upgrades</div><div>Platform expansion</div><div>Retained / strategic searches</div></div>
        </section>
        ...
        <section className="text-center max-w-3xl mx-auto">
          ...
          <p className="opacity-70 mb-8">If you are scaling a solar, storage, or EPC platform, Meridian Stone Search can support targeted hiring across your team.</p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="mailto:ian@meridianstonesearch.com?subject=Search%20Mandate%20Inquiry" className="inline-flex bg-black text-white px-8 py-4 rounded-full text-xs font-black uppercase tracking-widest hover:scale-105 transition-all">Email Ian</a>
