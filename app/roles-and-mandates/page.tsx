 ...
 return (
    <>
      ...
      <section className="max-w-5xl mx-auto text-center mb-24">
        ...
        <h1 className="text-4xl md:text-6xl font-black mb-6 leading-tight">Search coverage across the renewable energy lifecycle.</h1>
        <p className="text-lg opacity-70 max-w-3xl mx-auto">Meridian Stone Search partners with developers, EPCs, investors, and growth platforms to hire proven operators across solar, storage, and infrastructure.</p>
