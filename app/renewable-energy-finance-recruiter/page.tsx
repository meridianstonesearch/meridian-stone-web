      ...
      <main className="bg-[#F7F6F3] text-[#111111] min-h-screen font-sans px-6 md:px-12 pt-40 pb-24">
        ...
        <section className="max-w-6xl mx-auto text-center mb-32">
          ...
          <div className="flex items-center justify-center gap-3 mb-8 opacity-40">
            ...
            <span className="font-mono text-[10px] uppercase tracking-[0.3em] font-bold">Renewable Energy Finance Executive Search</span>
            <div className="h-px w-10 bg-[#111111]" />
          </div>
        ...
        <section className="max-w-5xl mx-auto mb-32">
          ...
          <div className="max-w-4xl mx-auto space-y-6 text-lg md:text-xl opacity-80 leading-relaxed font-medium text-center">
            <p>Renewable energy finance teams are being asked to underwrite in a market shaped by higher power demand, tax credit policy shifts, transferability execution, merchant exposure, interconnection risk, supply chain pressure, and rising expectations around capital efficiency.</p>
            <p>The strongest hires are not simply good analysts. They are the people who understand how project economics, tax strategy, capital structure, commercial assumptions, and construction reality all connect inside a live platform.</p>
          </div>
        </section>
        ...
        <section className="py-24 px-8 md:px-12 bg-[#111111] text-[#F7F6F3] mb-32">
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-6 text-lg opacity-80 leading-relaxed font-medium">
              <p>Finance sits at the center of project viability. Capital markets, tax equity or transferability strategy, debt sizing, valuation, underwriting discipline, and portfolio planning all influence whether a project can move from concept to notice to proceed and ultimately into operating cash flow.</p>
              <p>The strongest finance professionals in renewables are usually already embedded inside active platforms or live transactions. They are selective, difficult to access, and rarely surfaced through generic finance recruiting channels.</p>
              <p className="font-serif italic text-xl opacity-100">Successful hiring in finance requires search partners who understand both infrastructure capital and the operating realities behind the numbers.</p>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-6xl mx-auto mb-32">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white/50 border border-[#111111]/10 p-10 shadow-sm"><h3 className="text-xl font-black uppercase tracking-tight mb-6">Capital Markets &amp; Investment Strategy</h3><div className="h-px w-8 bg-[#111111]/20 mb-6" /><ul className="space-y-3 text-sm opacity-75 leading-relaxed font-medium"><li>Capital Markets</li><li>Infrastructure Investment Roles</li><li>Valuation &amp; Portfolio Strategy</li><li>M&amp;A / Platform Finance</li><li>Investor-Facing Finance Leadership</li></ul></div>
            <div className="bg-white/50 border border-[#111111]/10 p-10 shadow-sm"><h3 className="text-xl font-black uppercase tracking-tight mb-6">FP&amp;A &amp; Corporate Finance</h3><div className="h-px w-8 bg-[#111111]/20 mb-6" /><ul className="space-y-3 text-sm opacity-75 leading-relaxed font-medium"><li>FP&amp;A Leadership</li><li>Corporate Planning</li><li>Scenario Modeling</li><li>Board / Investor Reporting</li><li>Growth Platform Finance</li></ul></div>
            <div className="bg-white/50 border border-[#111111]/10 p-10 shadow-sm"><h3 className="text-xl font-black uppercase tracking-tight mb-6">Executive &amp; Commercial Finance</h3><div className="h-px w-8 bg-[#111111]/20 mb-6" /><ul className="space-y-3 text-sm opacity-75 leading-relaxed font-medium"><li>Chief Financial Officers</li><li>VP / SVP Finance</li><li>Commercial Strategy</li><li>Asset Management Finance</li><li>Executive Buildout Hires</li></ul></div>
          </div>
        </section>
        ...
        <section className="max-w-5xl mx-auto mb-24 text-center">
          ...
          <p className="opacity-70 mb-10 text-lg leading-relaxed font-medium max-w-3xl mx-auto">Meridian Stone Search supports targeted hiring across finance, development, solar, battery storage, EPC, and broader renewable energy platform buildouts.</p>
        ...
        <section className="text-center max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-black mb-4">Discuss a finance hiring mandate</h2>
          <p className="opacity-70 mb-8 text-lg leading-relaxed font-medium">If you are scaling a renewable energy platform and need stronger project finance, capital markets, FP&amp;A, or executive finance leadership, Meridian Stone Search can support targeted hiring across your team.</p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="mailto:ian@meridianstonesearch.com?subject=Finance%20Search%20Mandate" className="inline-flex bg-black text-white px-8 py-4 rounded-full text-xs font-black uppercase tracking-widest hover:scale-105 transition-all">Email Ian</a>
