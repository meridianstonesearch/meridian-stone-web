        ...
        <section className="py-32 px-6 md:px-12 bg-white border-t border-[#111111]/10">
          <div className="max-w-5xl mx-auto text-center space-y-12">
            ...
            <div className="space-y-6 text-lg md:text-xl opacity-80 leading-relaxed font-medium">
              ...
              <p className="font-semibold text-[#111111]">That’s where targeted search becomes critical.</p>
            </div>
          </div>
        </section>
        ...
        <section className="reveal-section py-40 px-6 md:px-12 bg-white/50">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20">
            <div className="reveal-item">
              ...
              <p className="text-xl opacity-70 leading-relaxed mb-8">We are a boutique executive search firm with global reach, specializing in renewable energy, infrastructure, construction, and real asset sectors. Our work is rooted in retained and confidential search models, partnering closely with leadership teams to build high-impact organizations — not just fill roles.</p>
            ...
            <div className="reveal-item space-y-8 text-lg opacity-80 leading-relaxed pt-0 md:pt-4 font-medium">
              <p>We do not operate transactionally. We embed ourselves in our clients’ strategic growth conversations — advising on team structure, succession planning, market compensation, and long-term scaling initiatives. Many of our engagements begin before a job description is ever written.</p>
              <p>Over the past several years, we have cultivated a trusted network of developers, EPC leaders, investors, operators, and executives across North America and international markets. These relationships were not built through volume — they were built through discretion, consistency, and results.</p>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
            ...
            <div className="reveal-item space-y-10">
              ...
              <div className="space-y-6 text-lg opacity-80 leading-relaxed font-medium">
                ...
                <p>He specializes in targeted, lifecycle-driven searches spanning early-stage development through engineering, procurement, and construction. Ian has successfully placed professionals at every level—from Project Engineers and Interconnection Managers to senior leadership and C-suite executives. His consultative approach enables him to deeply understand organizational structures, operational priorities, and long-term growth strategies, ensuring each search is aligned with both immediate needs and future objectives.</p>
                ...
                <p>Ian’s philosophy centers on building genuine, trust-based partnerships—serving as a strategic extension of his clients’ teams to ensure clarity, alignment, and lasting impact.</p>
              </div>
