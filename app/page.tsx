        ...
        <section className="relative min-h-screen flex flex-col justify-center items-center px-6 text-center pt-56 pb-32">
          <div className="max-w-7xl flex flex-col items-center">
            <div className="hero-reveal mb-16 md:mb-20">
               <img src="/Meridian Stone Search logo.png" alt="Meridian Stone Search Logo" className="h-32 md:h-48 w-auto object-contain brightness-95" />
            </div>
            
            <div className="hero-reveal flex items-center gap-3 mb-8 opacity-40">
              <div className="h-px w-10 bg-[#111111]" />
              <span className="font-mono text-[10px] uppercase tracking-[0.3em] font-bold">Boutique Executive Search for Renewable Energy & Infrastructure</span>
              <div className="h-px w-10 bg-[#111111]" />
            </div>
            ...
            <p className="hero-reveal max-w-3xl mx-auto text-xl md:text-3xl font-serif italic mb-10 opacity-80">
              We build high-performing teams across solar, storage, and EPC platforms nationwide.
            </p>
            ...
            <div className="hero-reveal grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4 text-left max-w-4xl mx-auto bg-white/50 p-8 border border-[#111111]/5">
              <div className="flex items-start gap-3"><Check size={18} className="mt-1 opacity-40 shrink-0"/> <span className="font-medium">Exclusive focus on renewable energy infrastructure</span></div>
              <div className="flex items-start gap-3"><Check size={18} className="mt-1 opacity-40 shrink-0"/> <span className="font-medium">Direct access to decision-makers</span></div>
              <div className="flex items-start gap-3"><Check size={18} className="mt-1 opacity-40 shrink-0"/> <span className="font-medium">Referral-driven candidate networks</span></div>
              <div className="flex items-start gap-3"><Check size={18} className="mt-1 opacity-40 shrink-0"/> <span className="font-medium">Confidential, strategic search mandates</span></div>
            </div>
          </div>
        </section>
    ...
    <div className="flex justify-center">
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 items-start">
            ...
            <div className="reveal-item space-y-10">
              ...
              <div className="pt-8 flex flex-col gap-6">
                ...
                <a href="https://www.linkedin.com/in/ian-farber-b73428233/" target="_blank" className="flex items-center gap-2 text-xs font-black uppercase tracking-widest border-b-2 border-[#111111] pb-1 hover:opacity-50 transition-all self-start mt-4">
      ...
      <footer className="py-20 px-6 md:px-12 border-t border-[#111111]/10 bg-[#F7F6F3]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8 text-center md:text-left">
          <img src="/Meridian Stone Search logo.png" className="h-8 opacity-80" alt="Logo" />
